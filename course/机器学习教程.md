...
5. 反向传播：
   ...
   由![image-20241023164037181](机器学习教程.assets/image-20241023164037181.png)，可将反向传播也看成一个逆向的神经网络，权重值就是$\sigma^{'}(Z)$，此时的输出就是$\frac{\sigma C}{\sigma z}$
...
![image-20241028210749625](E:\pythonworksation\机器学习\course\img\image-20241028210749625.png)
