...
if __name__ == '__main__':
    ...
    train_set = DatasetFolder("food-11/training/labeled", loader=load_image, extensions="jpg",
                              transform=train_tfm)
    valid_set = DatasetFolder("food-11/validation", loader=load_image, extensions="jpg",
                              transform=test_tfm)
    unlabeled_set = DatasetFolder("food-11/training/unlabeled", loader=load_image,
                                  extensions="jpg",
                                  transform=train_tfm)
    test_set = DatasetFolder("food-11/testing", loader=load_image, extensions="jpg",
                             transform=test_tfm)
